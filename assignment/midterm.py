        ...
        if hi == 1:
                        ...
                        while True:
                            if mode == 'study':
                                ...
                                if what == 3:
                                    ...
                                    for voca in vocafr:
                                        vocas.append(Voca(voca[0], voca[1]))
                                    vocaf.close()
                                    ...
                                    while True:
                                        ...
                                        if answer == vocas[rand_num].get_kor():
                                            ...
                                            cf = open(f"{login_user.get_name()}_voca.csv", "a", newline="", encoding='utf-8')
                                            cfw = csv.writer(cf)
            ...
            for i in range(count):
                if (mail == user_info_list[i][0]) and (name == user_info_list[i][2]):
                    print(
                        f'This is your password: {user_info_list[i][1][:int(len(user_info_list[i][1]) / 2)]}{"*" * (int(len(user_info_list[i][1]))-1)}')
